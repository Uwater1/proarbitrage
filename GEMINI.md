...
* **Over-trading and Friction Insights:** High-frequency aggressive limit orders crossing the spread pay severe transaction fee (2 CNY/contract) and microstructural spread friction. Backtest proves that crossing the spread constantly triggers excessive trading (123,948 traded contracts), completely wiping out the L1-norm surface anomaly edge unless passive limit orders or higher alpha hurdles (>65 bps) are used.
